      ...
      <span class="sr-only">Next</span>
    		...
    		'<div class="col-md-6" id="property-address">' . "</br>" . 
    			...
    			<div class="panel-heading"><span class="text-justify text-info" class="text-muted">' . ucwords( strtolower($item->property_name)) . '</span></div>
					...
					'</div>
					<form method="POST" action="" enctype="multipart/form-data" role="form-inline" name="delete_form" id="delete_form" onsubmit="return validateForm()">
  			
			
					<div class="col-md-4" id="property-address">
					<input type="hidden" name="property_id" id="property_id" class="property_id" value="' . $item->property_id . '">
					<button type="submit" class="btn btn-default btn-lg" id="button-group-admin" name="submit">Delete</button></a></small></p>
					</div>
					</form>
					</div>
...
<div class="jumbotron" id="main">
	...
	<div class="container-fluid">
		...
		<div class="jumbotron" id="nested">
    		...
    		<?php include("../includes/error_display.php"); ?>
    		
    		<div class="bg-danger text-justify text-danger" id="client-errors-box"><p class="text-justify text-danger" class="text-muted"></p></div> </br>
