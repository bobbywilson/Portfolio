...
<div class="jumbotron" id="main">
    ...
    <?php echo '<span class="glyphicon glyphicon-user"></span>' . " " . constant("CEO_NAME") . "</br>" . '<span class="glyphicon glyphicon-user" id="spacer"></span>' . " " . constant("CEO_TITLE") . "</br>" . " " . constant("CEO_PHONE") . "</br>" . " " . constant("CEO_EMAIL")?></br></br>
			...
			Being a strong leader and a firm believer that to be successful in this or any industry, you must be as dedicated to your industry and community as you are to your position. Mr. Attinger has volunteered for the Apartment Association in each of the markets in which he has worked.</p></br>
			
			<hr></br>
			
			<p class="text-justify" class="text-muted"><?php echo '<span class="glyphicon glyphicon-user"></span>' . " " . constant("VICE_NAME") . "</br>" . '<span class="glyphicon glyphicon-user" id="spacer"></span>' . " " . constant("VICE_TITLE") . "</br>" . " " . constant("VICE_PHONE") . "</br>" . " " . constant("VICE_EMAIL")?></br></br>
