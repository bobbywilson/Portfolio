...
<div class="container">
	...
	<div class="jumbotron jumbotron-home jumbotron-mobile">
		...
		<p class="body-font">Hello, my name is Bobby Wilson and I am a Web Developer. 
			I am a Object Oriented Programmer (OOP). I primarily build web systems using HTML5, CSS3, 
			JavaScript, PHP, MySQL and Bootstrap. I am skilled at building mobile and responsive layouts. 
			I also have experience with GitHub for version control, backup repository and collaboration.
		</p>
		
		<p class="body-font"> I am currently working as a Microsoft.Net Developer Apprentice at Eleven
			Fifty Consulting. In this role, I am learning C# and the Microsoft.Net framework in order to support the consulting team.
		</p>
